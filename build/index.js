 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,s,i,e){const n=s[0];if("."===n){return new A(t,s.slice(1),i).parts}return"@"===n?[new j(t,s.slice(1),e.eventContext)]:"?"===n?[new C(t,s.slice(1),i)]:new _(t,s,i).parts}handleTextExpression(t){return new k(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
let it=class extends st{constructor(){super(...arguments),this.name="World",this.count=0}render(){return V`
  ...
  `,t([K()],it.prototype,"name",void 0),t([K({type:Number})],it.prototype,"count",void 0),it=t([D("my-element")],it);let et=class extends st{constructor(){super(...arguments),this.text="",this.foo=""}render(){return V`
    ...
    `}update(t){console.log("update",t)}updated(t){console.log("updated",t)}_onClick(){let t=new CustomEvent("that-click",{detail:{message:"my-event happened."},bubbles:!0,composed:!0});this.dispatchEvent(t)}};et.styles=Z`
    :host {
      display: block;
    }
  ...
  `,t([K()],et.prototype,"text",void 0),t([K()],et.prototype,"foo",void 0),et=t([D("my-button")],et);
